...
with st.sidebar:
    ...
    st.markdown("""<a href="/2_CIRAD" target="_self" style="display:block;text-align:center;padding:8px;background:#1B4332;color:white;border-radius:6px;text-decoration:none;font-weight:600">🥑 Reporte CIRAD</a>""", unsafe_allow_html=True)
    st.divider()
    if USE_AZURE:
